...
public class QuickTimeEvent extends StoryEvent {
    ...
    // --- Getters and setters ---
    public Item getSuccessResult() { return successResult; }
    public void setSuccessResult(Item successResult) { this.successResult = successResult; }
    public Item getFailureResult() { return failureResult; }
    public void setFailureResult(Item failureResult) { this.failureResult = failureResult; }
    ...
    public boolean isEventSolvedCorrectly() { return eventSolvedCorrectly; }
    public void setEventSolvedCorrectly(boolean eventSolvedCorrectly) { this.eventSolvedCorrectly = eventSolvedCorrectly; }
    public ArrayList<Item> getItemsAffected() { return itemsAffected; }
    public void setItemsAffected(ArrayList<Item> itemsAffected) { this.itemsAffected = itemsAffected; }
}
